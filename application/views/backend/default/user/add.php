...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab"><?php echo t("Profile")?></a></li>
      <li><a href="#profile" data-toggle="tab"><?php echo t("Setup account")?></a></li>
    </ul>
...
San Jose, CA 95101
    ...
    <form id="tab2">
        <label><?php echo t("User name")?></label>
