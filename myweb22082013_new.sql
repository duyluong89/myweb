...
-- ----------------------------
INSERT INTO `admin_info` VALUES ('2', 'trinh', 'duy luong', null, 'male', null, null, null, null, null, '0', '0');
...
CREATE TABLE `admin_privilege` (
  ...
  PRIMARY KEY (`id`,`controller`,`method`,`user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- ----------------------------
INSERT INTO `system_block` VALUES ('8', 'header-phone', '<p>12343434232</p>\r\n', '1');
INSERT INTO `system_block` VALUES ('9', 'supported', '<p>0986636039</p>\r\n', '1');
